...
Item {
    ...
    signal cardClicked(string head, string desc, string icon, string link)
            ...
            GridLayout {
                ...
                Repeater {
                    ...
                    DropUnit {
                        ...
                        onUnitClicked: dropGrid.cardClicked(modelData.head, modelData.desc, modelData.icon, modelData.link || "")
                    }
                }
            }
        }
